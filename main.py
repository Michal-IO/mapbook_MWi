...
button_pokaz_szczegoly = Button(ramka_lista_obiekow, text='Pokaż szczegóły')
button_pokaz_szczegoly.grid(row=2, column=0)

button_usun_obiekt = Button(ramka_lista_obiekow, text='Usuń obiekt')
button_usun_obiekt.grid(row=2, column=1)

button_edytuj_obiekt = Button(ramka_lista_obiekow, text='Edytuj obiekt')
